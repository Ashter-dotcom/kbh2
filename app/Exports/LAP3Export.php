...
class LAP3Export extends \PhpOffice\PhpSpreadsheet\Cell\StringValueBinder implements FromView, WithColumnWidths, WithCustomValueBinder
{
    protected $tahun;
    protected $results;
    protected $bulan;
    ...
    public function view(): View
    {
        ...
        return view('ViewData.LAP3.export', ['data' => $this->data]);
    }
}
