...
class D8Export extends \PhpOffice\PhpSpreadsheet\Cell\StringValueBinder implements FromView, WithColumnWidths, WithCustomValueBinder
{
    protected $tahun;
    protected $results;
    protected $bulan;
    ...
    public function view(): View
    {
        ...
        return view('ViewData.D8.export', ['data' => $this->data]);
    }
}