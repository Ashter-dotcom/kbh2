...
class H4Export extends \PhpOffice\PhpSpreadsheet\Cell\StringValueBinder implements FromView, WithColumnWidths, WithCustomValueBinder
{
    ...
    public function view(): View
    {
        ...
        return view('ViewData.H4.export', ['data' => $this->data]);
    }
}
