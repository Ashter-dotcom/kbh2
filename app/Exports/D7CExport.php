...
class D7CExport implements FromView, WithStyles
{
    protected $apm;
    protected $periode;
    protected $results;
    ...
    public function view(): View
    {
        ...
        $this->data['periode_akhir'] = strtoupper(date_bahasa($this->periode->selesai, ['display_hari' => false]));
        ...
        return view('ViewData.D7C.export', ['data' => $this->data]);
    }
}