...
class H12Export extends \PhpOffice\PhpSpreadsheet\Cell\StringValueBinder implements FromView, WithColumnWidths, WithCustomValueBinder
{
    protected $tahun;
    protected $results;
    protected $bulan;
    ...
    public function view(): View
    {
        ...
        return view('ViewData.H12.export', ['data' => $this->data]);
    }
}
