...
@section('content')
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">H4</li>
            <li class="breadcrumb-item">{{ $apm->nama_perusahaan_apm }}</li>
        </ol>
    </nav>
    @include('component.alert')
    <form action="{{ route('view-data-d4a-lihat') }}" method="GET">
    ...
    <hr />
    @include('ViewData.D4A.Table',[ 'apm' => $apm, 'profil' => $profil, 'attribute' => $attribute, 'kondisi' => $kondisi, 'periodeTahun' => $periodeTahun ])
@endsection
