...
<p class="h2 text-center font-weight-bold">DATA KAPASITAS PRODUKSI TERPASANG</p>
<p class="h2 text-center font-weight-bold">{{ $apm->nama_perusahaan_apm }}</p>
<a href="{{ route('view-data-d4b-unduh', [ 'apm' => $apm->id ]) }}"><button class="btn btn-dark btn-sm float-right btn-unduh shadow"><i class="fa fa-save"></i> Unduh</button></a><br /><br />
