...
@section('content')
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">V4</li>
    ...
    <form action="{{ route('view-data-h4-index') }}" method="GET" class="needs-validation" novalidate>
    ...
    @if(!empty(request()->apm) && !empty(request()->model) && !empty(request()->periode))
        @if(!empty($data['results']['data']))
            <div class="title">
                ...
                <a href="{{ route('view-data-h4-unduh', ['apm' => request()->apm, 'model' => request()->model, 'periode' => request()->periode]) }}" class="btn btn-dark btn-sm float-right btn-unduh"><i class="fa fa-save"></i> Unduh</a>
            </div>
    ...
    let FormulirH4 = {
        ...
        selectApm: function() {
            $('.apm').select2({
                ...
                if(data.id != undefined) {
                    FormulirH4.selectModel(data.id);
                }
            });
        },
        ...
        selectModel: function(apmId) {
            ...
            $('.model').select2({
                ...
                if(data.id != undefined) {
                    FormulirH4.selectPeriode(data.id);
                }
            });
        },
