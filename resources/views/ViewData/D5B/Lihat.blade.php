...
@section('content')
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">H6B</li>
            <li class="breadcrumb-item">{{ $supplier->nama_perusahaan_supplier }}</li>
        </ol>
    </nav>
    @include('component.alert')
    <form action="{{ route('view-data-d5b-lihat') }}" method="GET">
    ...
    <hr />
    @include('ViewData.D5B.Table',[ 'supplier' => $supplier, 'profil' => $profil, 'attribute' => $attribute, 'kondisi' => $kondisi, 'periodeTahun' => $periodeTahun ])
@endsection
