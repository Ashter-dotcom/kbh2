...
<p class="h2 text-center font-weight-bold">PROFIL SUPPLIER SETELAH MENDAPATKAN INSENTIF LCEV</p>
<p class="h2 text-center font-weight-bold">{{ $supplier->nama_perusahaan_supplier }}</p>
<a href="{{ route('view-data-d5b-unduh', [ 'supplier' => $supplier->id ]) }}"><button class="btn btn-dark btn-sm float-right btn-unduh shadow"><i class="fa fa-save"></i> Unduh</button></a><br /><br />
...
<thead>
  <tr>
    ...
    <th class="tg-wa1i" colspan="12">12 Bulan Setelah Mendapatkan Insentif</th>
