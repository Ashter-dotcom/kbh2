...
@section('content')
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">V8</li>
    ...
    <form action="{{ route('view-data-d7a-index') }}" method="GET" class="needs-validation" novalidate>
    ...
    @if(!empty(request()->apm) && !empty(request()->periode))
        @if(!empty($data['results']))
            ...
            <div class="title">
                <p>REALISASI DATA PRODUKSI UNIT</p>
                ...
                <a href="{{ route('view-data-d7a-d7aunduh', ['apm' => request()->apm, 'periode' => request()->periode]) }}" class="btn btn-dark btn-sm float-right btn-unduh"><i class="fa fa-save"></i> Unduh</a>
            </div>
