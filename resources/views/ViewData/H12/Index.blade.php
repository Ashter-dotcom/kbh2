...
@section('content')
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">V12</li>
    ...
    <form action="{{ route('view-data-h12-index') }}" method="GET" class="needs-validation" novalidate>
    ...
    @if(!empty(request()->apm) && !empty(request()->model) && !empty(request()->supplier))
        @if(!empty($data['results']))
            <div class="title">
                ...
                <a href="{{ route('view-data-h12-h12unduh', ['apm' => request()->apm, 'model' => request()->model, 'supplier' => request()->supplier]) }}" class="btn btn-dark btn-sm float-right btn-unduh"><i class="fa fa-save"></i> Unduh</a>
            </div>
                ...
                <table class="table table-bordered">
                    <thead>
                        <tr>
                            ...
                            <th rowspan="2" style="background-color:#56565c; text-align:center; vertical-align:middle; text-align:center">Data</th>
                            <th rowspan="2" style="background-color:#56565c; text-align:center; vertical-align:middle; text-align:center">Nama Komponen</th>
                            <th rowspan="2" style="background-color:#56565c; text-align:center; vertical-align:middle; text-align:center">Nama Komponen Aktual</th>
                            <th colspan="{{ count($data['bulan']['2021']) }}" style="background-color:#56565c; text-align:center; vertical-align:middle; text-align:center">Tahun 2022</th>
                            <!-- <th colspan="{{ count($data['bulan']['2022']) }}" style="background-color:#56565c; text-align:center; vertical-align:middle; text-align:center">Tahun 2023</th> -->
                            <th rowspan="2" style="background-color:#56565c; text-align:center; vertical-align:middle; text-align:center">Total</th>
                        ...
                        <tr>
                            @foreach($data['bulan']['2021'] as $keyBulan => $valueBulan)
                                <th style="background-color:#56565c; text-align:center; vertical-align:middle; text-align:center">{{ $valueBulan }}</th>
                            @endforeach
...
@push('scripts')
    ...
    <script>
        let FormulirH12 = {
            init: function() {
                FormulirH12.selectApm();
                FormulirH12.selectSupplier();
            },
            ...
            selectApm: function() {
                $('.apm').select2({
                    ...
                    if(data.id != undefined) {
                        FormulirH12.selectModel(data.id);
                    }
                });
            },
