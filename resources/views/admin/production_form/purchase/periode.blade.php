                    ...
                    <div class="card">
                        ...
                        <div class="card-body card-body-custom">
                            ...
                            <div class="col text-center">
                                <a href="{{ route('form_produksi.purchase.index-purchase', ['model_id' => request()->model_id, 'period_id' => $period->id]) }}" class="btn btn-dark btn-sm"><i class="fas fa-eye"></i> Lihat</a>
                            </div>
                        </div>
                    </div>
                </div>
