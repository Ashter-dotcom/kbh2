...
@section('content')
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">Sebelum Insentif</li>
        </ol>
    </nav>
    @include('component.alert')
    @include('ProfilPerusahaan.Component.Title', ['title' => '12 Bulan Sebelum Mendapatkan Insentif'])

    <div class="accordion" id="accordion">
        <form action="{{ route('profil-perusahaan-apm-sebelum-insentif-update', ['id'=>$apm->id]) }}" method="GET" class="needs-validation" novalidate>
        ...
        <form action="{{ route('profil-perusahaan-apm-sebelum-insentif-update', ['id'=>$apm->id]) }}" method="POST">
            @csrf
