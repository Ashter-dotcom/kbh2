...
@section('content')
    ...
    <form action="{{ route('master-data-periode-store') }}" method="POST">
        @csrf
            ...
            <div class="card-body">
                <div class="form-row">
                    <div class="form-group col-md-4 col-xs-12 col-sm-12 col-lg-4">
                        ...
                        <input type="text" name="nama_periode" class="form-control {{ $errors->has('nama_periode') ? 'is-invalid' : '' }}" id="nama_periode" placeholder="Nama Periode" value="{{ old('nama_periode') }}">
                        @error('nama_periode')
                    ...
                    <div class="form-group col-md-4 col-xs-12 col-sm-12 col-lg-4">
                        ...
                        <input id="mulai" type="date" name="mulai" class="form-control">
                        @error('mulai')
                            {{ $message }}
                            <div class="invalid-feedback">
                                {{ $message }}
                    ...
                    <div class="form-group col-md-4 col-xs-12 col-sm-12 col-lg-4">
                        ...
                        <input id="selesai" type="date" name="selesai" class="form-control">
                        @error('selesai')
                            {{ $message }}
                            <div class="invalid-feedback">
                                {{ $message }}
                    ...
                    <!-- <div class="form-group col-md-4 col-xs-12 col-sm-12 col-lg-4">
                        ...
                        <select multiple id="kelompok_kapasitas_silinder" name="kelompok_kapasitas_silinder[]" class="form-control {{ $errors->has('kelompok_kapasitas_silinder') ? 'is-invalid' : '' }}"></select>
