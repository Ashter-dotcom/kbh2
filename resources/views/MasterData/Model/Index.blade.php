...
@section('content')
    ...
    <a href="{{ route('master-data-model-create') }}" class="btn btn-dark btn-icon-split float-right tombol-tambah">
        <span class="icon text-white-100">
            <i class="fa fa-plus"></i>
        </span>
        <span class="text"><b>Tambah Model</b></span>
    </a>
