...
@section('content')
    ...
    <form action="{{ route('master-data-model-store') }}" method="POST">
        @csrf
            ...
            <div class="card-body">
                <div class="form-row">
                    ...
                    <div class="form-group col-md-3 col-xs-12 col-sm-12 col-lg-3">
                        ...
                        <select id="merek_id" name="merek_id" class="form-control {{ $errors->has('merek_id') ? 'is-invalid' : '' }}"></select>
                        @error('merek_id')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                        ...
                        <div class="tab-pane fade show {{ ($urutan == 1) ? 'active' : '' }}" id="link-id-{{$kat->id}}" role="tabpanel" aria-labelledby="tab-{{$kat->id}}">
                            <div class="form-row">
                                @foreach ($komponen as $k)
                                    ...
                                    <div class="form-group col-md-3 col-xs-12 col-sm-12 col-lg-4">
