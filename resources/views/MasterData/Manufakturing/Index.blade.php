...
@section('content')
    ...
    <a href="{{ route('master-data-manufakturing-create') }}" class="btn btn-dark btn-icon-split float-right tombol-tambah">
        <span class="icon text-white-100">
            <i class="fa fa-plus"></i>
        </span>
        <span class="text"><b>Tambah Manufakturing</b></span>
    </a>
        ...
        $(document).ready(function () {
            $(document).on('click', '.delete-item', function (e) {
                let self = $(this),
                    ...
                    dataTableID = "manufakturing-table";
