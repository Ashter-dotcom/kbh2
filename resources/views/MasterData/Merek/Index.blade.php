...
@section('content')
    ...
    <a href="{{ route('master-data-merek-create') }}" class="btn btn-dark btn-icon-split float-right tombol-tambah">
        <span class="icon text-white-100">
            <i class="fa fa-plus"></i>
        </span>
        <span class="text"><b>Tambah Merek Produk</b></span>
    </a>
